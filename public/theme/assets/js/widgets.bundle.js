                    ...
                    e.forEach((r) => {
                        r.addEventListener("click", (o) => {
                            ...
                            e.forEach((e) => {
                                ...
                                r.classList.add(...a),
                                "Show All" === i ? t.search("").draw() : t.search(i).draw();
                        });
                    });
                })(),
                a());
            ...
            e.forEach((e, a) => {
                e.addEventListener("click", (r) => {
                    ...
                    if (i.classList.contains("isOpen")) {
                        for (; i.nextSibling &&
                            "subtable_template" ===
                            i.nextSibling.getAttribute("data-kt-table-widget-4");
        ...
        init: function() {
            ...
            ((() => {
                    e.querySelectorAll("tbody tr").forEach((e) => {
                        ...
                        e.closest('[data-kt-table-widget-4="subtable_template"]') ||
        ...
        !(function() {
            ...
            if (e) {
                ...
                s("#E4E6EF", t.lineWidth, 1),
                    s(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, 100 / 150),
                    s(KTUtil.getCssVariableValue("--bs-success"), t.lineWidth, 0.4);
            }
        })();
    },
};
    ...
    init: function() {
        !(function() {
            ...
            if (e) {
                ...
                s("#E4E6EF", t.lineWidth, 1),
                    s(KTUtil.getCssVariableValue("--bs-danger"), t.lineWidth, 100 / 150),
                    s(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, 0.4);
            }
        })();
    },
};
                ...
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    o = new ApexCharts(e, {
                        series: [{
                            name: "Net Profit",
                            data: [
                                35, 25, 45, 15, 60, 50, 57, 35, 70, 40, 45, 25, 45, 30, 70,
                            ],
                        }, ],
                        chart: {
                            fontFamily: "inherit",
                ...
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    o = new ApexCharts(e, {
                        series: [{
                            name: "Net Profit",
                            data: [
                                35, 25, 35, 15, 40, 60, 25, 40, 70, 30, 55, 45, 45, 30, 50,
                            ],
                        }, ],
                        chart: {
                            fontFamily: "inherit",
            ...
            e(
                ...
                e(
                    ...
                    "#kt_chart_widget_11_chart_2", [
                        ...
                        20, 22, 15, 18, 18, 17, 17, 15, 15, 17, 17, 19, 17,
                    ], !1
                ),
                e(
                    "#kt_chart_widget_11_tab_3",
                    "#kt_chart_widget_11_chart_3", [
                        17, 20, 20, 19, 19, 17, 17, 19, 19, 21, 21, 19, 19, 21, 21, 18, 18,
                        16, 17, 17, 19, 19, 21, 21, 19, 19, 17, 17, 18, 18,
                    ], !0
                );
        },
    };
                ...
                e &&
                    am5.ready(function() {
                        ...
                        i.get("renderer").grid.template.setAll({
                            ...
                            s("Cars", "cars", KTUtil.getCssVariableValue("--bs-primary")),
                            s(
                                "Motorcycles",
                                "motorcycles",
                                KTUtil.getCssVariableValue("--bs-success")
                    ...
                    am5.ready(function() {
                        ...
                        !(function() {
                            ...
                            for (t = 0; t < r.length; t++)
                                (o += a = r[t].visits), (r[t].pareto = (o / e) * 100);
                        })();
                        var o = a.xAxes.push(
                            am5xy.CategoryAxis.new(t, {
                                categoryField: "country",
                ...
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    s = new ApexCharts(e, {
                        series: [{
                            name: "Discounted",
                            data: [
                                34.5, 34.5, 35, 35, 35.5, 35.5, 35, 35, 34.5, 34.5, 34.5,
                                34.5, 35, 35, 34.5, 35.5, 35.5, 35.5, 35,
                            ],
                        }, ],
                        chart: {
                            fontFamily: "inherit",
                    ...
                    r = new ApexCharts(e, {
                        ...
                        yaxis: {
                            labels: {
                                ...
                                style: { colors: t, fontSize: "14px", fontWeight: "600" },
                                offsetY: 2,
                                align: "left",
                            },
                        },
        ...
        !(function() {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    s = {
                        series: [
                            { name: "Net Profit", data: [21, 21, 26, 26, 31, 31, 27] },
