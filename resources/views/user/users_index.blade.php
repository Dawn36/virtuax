                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        @for ($i = 0; $i < count($users); $i++) @php $a=$i; $a++; @endphp <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary" data-bs-original-title="Edit User" onclick="editUser('{{ $users[$i]->id}}')">
                                                ...
                                                <form  style="display: inline-block" method="POST" action="{{ route('user.destroy', $users[$i]->id) }}">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger" data-bs-toggle="tooltip" data-bs-original-title="Delete User">
